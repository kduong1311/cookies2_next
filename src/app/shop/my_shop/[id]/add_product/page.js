...
export default function CreateProductPage({ onBack, shopId }) {
    ...
    <div className="bg-gray-800 min-h-screen pb-12">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-8 text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-blue-100">Add a new product to your shop</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-700 rounded-lg shadow-lg p-6 sticky top-6">
                <h2 className="text-2xl font-bold mb-4 text-gray-100 flex items-center">
                  <span className="w-1 h-8 bg-blue-500 mr-3 rounded-full"></span>
                  Product Images
                </h2>
